		...
		<div class="row">
			<div class="col-md-6 pr-md-5">
				...
				<div class="row profile-btns">
					...
					<div class="photos tabs row px-3">
						<div class="col-md-3 col-6 order-1 order-md-1 pt-md-0 pt-3 px-1 pb-2 pb-md-0">
							<a class="example-image-link" href="Profiles/<?php echo $ID; ?>/images/p012.jpg" data-lightbox="photos-set" ><img src="Profiles/<?php echo $ID; ?>/images/min/p012.jpg" alt="" class="w-100"></a>
							<a class="example-image-link" href="Profiles/<?php echo $ID; ?>/images/p016.jpg" data-lightbox="photos-set" ><img src="Profiles/<?php echo $ID; ?>/images/min/p016.jpg" alt="" class="w-100"></a>
						</div>
						<div class="col-md-3 col-6 order-3 order-md-2 px-1">
							<a class="example-image-link" href="Profiles/<?php echo $ID; ?>/images/p013.jpg" data-lightbox="photos-set" ><img src="Profiles/<?php echo $ID; ?>/images/min/p013.jpg" alt="" class="w-100"></a>
							<a class="example-image-link" href="Profiles/<?php echo $ID; ?>/images/p017.jpg" data-lightbox="photos-set" ><img src="Profiles/<?php echo $ID; ?>/images/min/p017.jpg" alt="" class="w-100"></a>
						</div>
						<div class="col-md-3 col-6 order-2 order-md-3 pt-md-0 pt-3 px-1 pb-2 pb-md-0">
							<a class="example-image-link" href="Profiles/<?php echo $ID; ?>/images/p014.jpg" data-lightbox="photos-set" ><img src="Profiles/<?php echo $ID; ?>/images/min/p014.jpg" alt="" class="w-100"></a>
							<a class="example-image-link" href="Profiles/<?php echo $ID; ?>/images/p018.jpg" data-lightbox="photos-set" ><img src="Profiles/<?php echo $ID; ?>/images/min/p018.jpg" alt="" class="w-100"></a>
						</div>
						<div class="col-md-3 col-6 order-4 order-md-4 px-1">
							<a class="example-image-link" href="Profiles/<?php echo $ID; ?>/images/p015.jpg" data-lightbox="photos-set" ><img src="Profiles/<?php echo $ID; ?>/images/min/p015.jpg" alt="" class="w-100"></a>
							<a class="example-image-link" href="Profiles/<?php echo $ID; ?>/images/p019.jpg" data-lightbox="photos-set" ><img src="Profiles/<?php echo $ID; ?>/images/min/p019.jpg" alt="" class="w-100"></a>
						</div>

						<div class="col-md-3 col-6 order-last order-md-last px-1 mt-3" data-section="photos" data-deleteid="extra_1">
                            <div class="cropped-image mb-2">
                                <?php
                                $count = count($photos);
                                echo ' 
								<a class="example-image-link" href="Profiles/'.$ID.'/images/photos/'.$photos[3].'" data-lightbox="photos-set" >
									<img src="Profiles/'.$ID.'/images/photos/'.$photos[3].'" alt="" class="w-100 py-0">
					...
					<div class="photobooks tabs row px-3" style="display: none">
						...
						<div class="col-md-3 col-6 order-last order-md-last px-1 mt-3" data-section="photobooks" data-deleteid="extra_2">
							<div class="cropped-image mb-2">
                                <?php
                                $count = count($photobooks);
                                echo ' 
								<a class="example-image-link" href="Profiles/'.$ID.'/images/photobooks/'.$photobooks[3].'" data-lightbox="photobooks-set" >
									<img src="Profiles/'.$ID.'/images/photobooks/min/'.$photobooks[3].'" alt="" class="w-100 py-0">
									<span class="more-photos-overlay d-flex align-items-center justify-content-center text-center">
										+'.$count.'<br>
										fotiek
									</span>
								</a>';
                                for ($i = 3; $i < count($photobooks); $i++) {
					...
					<div class="polaroids tabs row px-3" style="display: none">
						<!--<div class="col-md-3 col-6 pr-1 order-1 order-md-1 pt-md-0 pt-3">
						...
						<div class="col-md-3 col-6 order-last order-md-last px-1 mt-3" data-section="polaroids" data-deleteid="extra_3">
							<div class="cropped-image mb-2">
                                <?php
                                $count = count($polaroids);
                                echo ' 
								<a class="example-image-link" href="Profiles/'.$ID.'/images/polaroids/'.$polaroids[3].'" data-lightbox="polaroids-set" >
									<img src="Profiles/'.$ID.'/images/polaroids/min/'.$polaroids[3].'" alt="" class="w-100 py-0">
									<span class="more-photos-overlay d-flex align-items-center justify-content-center text-center">
										+'.$count.'<br>
										fotiek
									</span>
								</a>';
                                for ($i = 3; $i < count($polaroids); $i++) {
