...
<section id="member-banner" style="background-image: url(../images/komparz-banner.jpg);">
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<h1 class="pt-6 pb-5">TRHOVISKO</h1>
			</div>
...
<section id="add_casting">
    <form action="PHP/addMarket.php" method="post" enctype="multipart/form-data">
	<div class="container py-5">
		<div class="row">
			...
			<div class="col-md-3 right mt-md-0 mt-3">
				...
				<input name="name" type="text" placeholder="Názov" data-necessary="text">
				<input name="place" type="text" placeholder="Miesto" data-necessary="text">
				...
				<textarea name="description" id="description" class="mt-3" rows="5" placeholder="Popis" maxlength="255"></textarea>
				<div class="type">
					<select name="category" id="category" class="filter mt-3" data-placeholder="Kategória" data-necessary="text">
						<option></option>
						<option value="cat1">Foto sekcia</option>
						<option value="cat2">Kurzy a služby</option>
						<option value="cat3">Dopyty</option>
					</select>
				</div>
				<div class="inline">
				...
				<input name="price" type="text" placeholder="Pôvodná cena" data-necessary="text">
				<input name="pricesale" type="text" placeholder="Cena po zľave">
				<input name="honorar" type="text" placeholder="Honorár (povinné)" data-necessary="text">
			</div>
			<div class="col-md-3">
				<h3>Vaše údaje</h3>
				<input name="company" type="text" placeholder="Meno/názov spoločnosti" data-necessary="text">
				<input name="phone" type="text" placeholder="Telefónne číslo" data-necessary="text">
				<input name="dateTo" type="text" placeholder="Platnosť" data-necessary="text">
				<input name="IBAN" type="text" placeholder="IBAN" data-necessary="text">
				...
				<div class="custom-control square-checkbox py-md-3 pt-3">
					<input type="checkbox" class="custom-control-input" id="start" name="onlineSales">
...
<div class="overlay-crop js">
    <div class="modal-crop" id="modal-crop">
        <div class="content">
            ...
            <button type="button" id="crop_button" class="btn btn-primary w-100">Crop</button>
        </div>
    </div>
</div>
