	...
	<div class="container-fluid pr-md-0">
		...
		<div class="collapse navbar-collapse text-lg-left text-center" id="navbarDefault">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item">
					<a class="nav-link" href="./membership.php">Registrácia / Členstvo</a>
				</li>
				<li class="nav-item">
			...
			<ul class="navbar-nav ml-auto">
				<a href="" class="menu"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
				<a href="" class="menu mr-xl-3"><i class="fa fa-instagram" aria-hidden="true"></i></a>
				<a href="#" class="btn btn-navbar login">Prihlásiť sa</a>
				<a href="./membership.php" class="btn btn-navbar reg">Registovať sa</a>
			</ul>
		</div>
	</div>
</nav>