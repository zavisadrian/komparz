...
<section id="thank-you">
	<div class="container py-7 text-center mt-6">
		<h1>Zabudnuté heslo</h1>
			<form action="PHP/restorePass-2-casting.php" method="post" class="row pt-4">
				<div class="col-md-6">
                    ...
                    <input name="session" type="hidden" value="<?php echo $_REQUEST['session']; ?>">
				</div>
				<div class="col-md-6">
