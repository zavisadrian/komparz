        ...
        <div class="container py-4">
                    ...
                    <div class="">
                        ...
                        <div class="row pt-4" id="form">
                            ...
                            <div class="col-6">
                                ...
                                <select class="filter" data-placeholder="Kraj" name="nationality" data-necessary="text">
                                    <option value=""></option>
            ...
            <div class="row">
                <div class="col-6">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="actingenjoy" value="herectvo, " name="cr3">
                                    <label class="custom-control-label " for="actingenjoy">Herectvo</label>
                                </div>
                                <div class="custom-control custom-checkbox">
