		...
		<div class="row">
			...
			<div class="col-md-6 text-md-right pt-md-3">
                ...
                if (isset($_SESSION['marketMail'])) {
                    echo "<a href='marketplace-own.php' class=\"btn btn-white my-5\">MOJE PONUKY</a>";
                    echo "<a href=\"PHP/marketLogout.php\" class=\"btn btn-outline-white ml-2 my-5\">ODHLÁSIŤ SA ZO SPRÁVY</a>";
                } else {
                    echo "<a id=\"findCasting\" class=\"btn btn-white my-5\">SPRAVOVAŤ PONUKY</a>";
                }
                ?>
			</div>
		</div>
	...
	<div class="container pb-5">
		<div class="row">
			<div class="col-md-12">
                ...
                <?php
                $conn = dbConnect();
                $sql = "SELECT * FROM `market` ORDER BY `auto` DESC";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <div class=\"row no-gutters pt-5\">
						    ...
						    <a class=\"show-link\" href=\"./want-ad.php?ID=".$row['ID']."\">Viac <br> info <br><i class=\"fa fa-long-arrow-right\" aria-hidden=\"true\"></i></a>
					        </div>
				        </div>
                        ";
                    }
