...
<section id="thank-you">
	<div class="container py-7 text-center mt-6">
		...
		<form class="row pt-4" method="post" action="PHP/restorePass-1-market.php" onsubmit="return emailVerify()">
			<div class="col-md-6 offset-md-3">
				<label for="name" class="mb-0 mt-3"><strong>Zadajte E-mail</strong></label>
				<input id="mail" type="text" class="registration-input" name="mail"/>
			</div>
			<div class="col-md-6 offset-md-3">
				<input type="submit" value="Potvrdiť" class="btn btn-primary w-100 my-5"/>
			</div>
		</form>
	</div>
</section>
