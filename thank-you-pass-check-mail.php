...
<section id="thank-you">
	<div class="container py-7 text-center mt-6">
		<h1>Aby heslo bolo zmenené, skontroluj svoju emailovú schránku.</h1>
		<div class="row">
			<div class="col-md-4 offset-md-4 pt-md-3">
				<a href="profile-acter.php?ID=<?php echo $_SESSION['userID']; ?>" class="btn btn-primary w-100 my-5">Späť na profil</a>
			</div>
		</div>
	</div>
</section>
