...
<section id="thank-you">
	<div class="container py-7 text-center mt-6">
		<h1>Ďakujeme za Vašu registráciu</h1>
		<div class="row">
			<div class="col-md-4 offset-md-4 pt-md-3">
				<a href="PHP/login.php?ID=<?php echo $_REQUEST['ID']; ?>&password=<?php echo $_REQUEST['pass']; ?>&mail=<?php echo $_REQUEST['mail']; ?>" class="btn btn-primary w-100 my-5">Pokračovať na môj profil</a>
			</div>
		</div>
	</div>
</section>
