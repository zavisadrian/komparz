...
<section id="thank-you">
    <div class="container py-7 text-center mt-6">
        <h1>Dáta boli úspešne zaregistrované. Teraz si môžeš pridávať ponuky v trhovisku.</h1>
        <div class="row">
            <div class="col-md-4 offset-md-4 pt-md-3">
                <a href="PHP/marketLogin.php?mail=<?php echo $_SESSION['casting_email']; ?>&password=<?php echo $_SESSION['casting_pass']; ?>" class="btn btn-primary w-100 my-5">Prejsť na trhovisko</a>
            </div>
        </div>
    </div>
</section>
