			...
			<div class="col-md-3 right mt-md-0 mt-3">
                ...
                <div class="custom-file text-center cropped-image">
                    <label class="custom-file-label text-left" for="file">
                        <input type="file" data-section="main" name="castingImage" id="file" data-unlock="p011" data-cropimageid="file" data-aspectratio="<?= 2/1 ?>" class="image-upload-input custom-file-input"/><input type="hidden">
                        Fotografia</label>
