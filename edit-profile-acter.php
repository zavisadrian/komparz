...
<section id="profile" style="background-image: url(../images/komparz-banner.jpg);">
					...
					<div class="row pt-4">
                        ...
                        <div class="col-6">
                            ...
                            <select name="nationality" id="nationality" class="filter" data-placeholder="Národnosť" onchange="realTimeResultCount()">
                                <option value=""></option>
                                <option value="Slovenská" <?php if ($region == "Slovenská")  echo "selected"; ?>>Slovenská</option>
                                <option value="Česká" <?php if ($region == "Česká")  echo "selected"; ?>>Česká</option>
                                <option value="Polská" <?php if ($region == "Polská")  echo "selected"; ?>>Polská</option>
                                <option value="Maďarská" <?php if ($region == "Maďarská")  echo "selected"; ?>>Maďarská</option>
                                <option value="Iná" <?php if ($region == "Iná")  echo "selected"; ?>>Iná</option>
                            </select>
                        </div>
						<div class="col-6">
    ...
    <form style="all: unset;" action="Admin/PHP/deleteProfile.php" method="post" onsubmit="return confirm('Naozaj chcete vymazať profil?')">
        <input type="hidden" value="<?php echo $ID; ?>">
        <button type="submit" class="btn btn-primary w-50 mt-4" style="margin: 0 0 30px 5% !important; width: 14.5% !important; max-width: 200px; min-width: 200px;">Vymazať profil</button>
    </form>
</section>
