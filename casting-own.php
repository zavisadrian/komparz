	...
	<div class="container">
		<div class="row">
            ...
            <div class="col-md-8 text-md-right pt-md-3">
                <a href='castings.php' id=\"cancelEdit\" class="btn btn-white my-5">ZOBRAZIŤ VŠETKO</a>
                <a href='casting-create.php' id=\"cancelEdit\" class="btn btn-white my-5">VYTVORIŤ NOVÝ</a>
                <a href="PHP/castingLogout.php" class="btn btn-outline-white my-5">ODHLÁSIŤ SA ZO SPRÁVY</a>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container py-5">
		<div class="row">
            <div class="col-12">
                ...
                $conn = dbConnect();
                $sql = "SELECT * FROM `casting` WHERE `owneremail` = '".$_SESSION['castingMail']."' ORDER BY `auto` DESC";
                    ...
                    while($row = $result->fetch_assoc()){
                        ...
                        <div class=\"row mt-5\" id='".$row['ID']."''>
					        ...
					        <div class=\"col-md-7 px-md-1 desc pl-md-3 position-relative\">
                                <a class=\"map\" href=\"casting-edit.php?id=".$row['ID']."\">UPRAVIŤ</a>
					    	    ...
					    	    <a class=\"btn btn-secondary mt-3 w-50 opacity-50\" style='opacity: 0.5;'>Zúčastniť sa</a>
					        </div>
				        </div>
                        ";
                    }
                } else echo "<h2>Zatiaľ žiadne castingy.</h2>";
                ?>
            </div>
...
<section id="modal-template">
	...
	<!-- Modal content -->
		<div class="modal-content text-center p-5">
			<h2 calss="mb-2">Prihlásiť sa na správu castingov</h2>
