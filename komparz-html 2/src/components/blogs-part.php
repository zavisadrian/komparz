<div class="row no-gutters pt-5">
	<div class="col-lg-4">
		<img src="images/membership.jpg" alt="" class="w-100">
	</div>
	...
	<div class="col-lg-2 text-center bg-under-link py-6">
		<a class="show-link" data-showmore=".first">Viac <br> info <br><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
	</div>
</div>
<div class="description first" style="display: none;">
	<div class="row pt-4">
		<div class="col-md-7">
		...
		<div class="col-md-5 px-md-1 desc">
			...
			<p class="pt-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
