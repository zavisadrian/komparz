        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary cs-header-headline-withinput orangeText">Modeli / Modelky</h6>
                ...
                <a href="form_addModel.php" class="unset"><button class="btn btn-primary cs-header-button desktop" type="button">Vytvoriť</button></a>
            </div>
            <div class="card-body">
                        ...
                        echo "
                            <tr class='cs-table-row'>
                                ...
                                <td style='padding: 5px;'>
                                    ...
                                    <a href=\"form_editModel.php?ID=".$row['ID']."\" class=\"btn btn-icon-split\" style='transform: scale(0.8); background-color: #1F76E0; border-color: #1F76E0;'>
                                    <span class=\"icon text-white-50\" style='color: rgba(255, 255, 255, 0.7)!important;'>
