    ...
    <div id="content">
        ...
        <section id="profile" style="background-image: url(../images/komparz-banner.jpg);" class="mt-0">
            <form action="../PHP/addProfile.php" method="post" enctype="multipart/form-data" id="edit_acter">
                <div class="container py-7 pt-2 text-center" id="form">
                ...
                <div class="container py-4">
                    <div class="row pb-4">
                        ...
                        <div class="col-md-6" id="form">
                            <div class="">
                                <h3>Informácie o Fotografovi</h3>
                                <div class="row pt-4">
                                    <div class="col-6">
                                        <label for="name" class="mb-0 mt-3"><strong>Meno</strong> *</label>
                                        <input type="text" class="registration-input" name="name"/>
                                        <input type="hidden" class="registration-input" name="type" value="photographer" data-necessary="text"/>
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="registration-input" name="web" data-necessary="text"/>
                                    </div>
                                    <div class="col-6">
