...
$content = file_get_contents('../Blog/'.$blog['htmlContent'].'/blog.html');
?>
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800">Upraviť blog</h1>
            <!-- DataTales Example -->
            <form class="card shadow mb-4" action="PHP/editBlog.php" method="post" enctype="multipart/form-data">
                <div class="card-header py-3">
                    <input value="<?php echo $blog['htmlContent']; ?>" type="hidden" name="ID">

                    <h6 class="m-0 font-weight-bold text-primary cs-input-label">Nadpis</h6>
                    <input value="<?php echo $blog['headline']; ?>" name="headline" type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="AKO NA TO?!...">

                    <h6 class="m-0 font-weight-bold text-primary cs-input-label">Hlavný text</h6>
                    <input value="<?php echo $blog['mainText']; ?>" name="mainText" type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Tento článok slúži na pochopenie ako na...">
                    ...
                    <textarea data-editor="true" name="html" class="w-100"><?php echo $content; ?></textarea>
