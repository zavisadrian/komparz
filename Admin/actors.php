        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary cs-header-headline-withinput orangeText">Herci / komparzisti</h6>
                ...
                <a href="form_addActor.php" class="unset"><button class="btn btn-primary cs-header-button desktop" type="button">Vytvoriť</button></a>
            </div>
            <div class="card-body">
                        ...
                        echo "
                            <tr class='cs-table-row'>
                                ...
                                <td style='padding: 5px;'>
                                    <a href=\"../profile-acter.php?ID=".$row['ID']."\" target='_blank' class=\"btn btn-icon-split\" style='transform: scale(0.8); background-color: #e18b1e; border-color: #e18b1e;'>
                                    ...
                                    <a href=\"form_editActor.php?ID=".$row['ID']."\" class=\"btn btn-icon-split\" style='transform: scale(0.8); background-color: #1F76E0; border-color: #1F76E0;'>
                                    <span class=\"icon text-white-50\" style='color: rgba(255, 255, 255, 0.7)!important;'>
                                        <i class=\"fas fa-edit\"></i>
                                    </span>
                                    <span class=\"text\" style='color: white;'>Upraviť</span>
                                    </a>
                                    <form action=\"PHP/deleteProfile.php\" method='post' onsubmit=\"return confirm('Naozaj chcete vymazať profil?')\">
                                        <input type='hidden' name='ID' value='".$row['ID']."'>
                                        <button type='submit' class=\"btn btn-icon-split\" style='transform: scale(0.8); background-color: #DE1F22; border-color: #DE1F22;'>
                                            <span class=\"icon text-white-50\" style='color: rgba(255, 255, 255, 0.7)!important;'>
