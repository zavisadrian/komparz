...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid" style="padding: 0;">
            ...
            <section id="profile" style="background-image: url(../images/komparz-banner.jpg); margin-top: 0">
                                ...
                                <div class="">
                                    ...
                                    <div class="row pt-4">
                                        <div class="col-6">
                                            ...
                                            <input type="hidden" class="registration-input" name="type" value="actor"/>
                                        </div>
                                        <div class="col-6">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="registration-input" name="nationality" data-necessary="text"/>
                                        </div>
                                        <div class="col-6">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input name="date_of_birth" type="text" placeholder="Dátum narodenia" data-provide="datepicker" data-date-language="sk" data-necessary="date">
                                        </div>
                                        <div class="col-6">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="acting" value="herectvo, " name="in1">
                                                <label class="custom-control-label " for="acting">Herectvo</label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="comparz" value="komparz, " name="in2">
                                                <label class="custom-control-label " for="comparz">Komparz</label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="comparz_text" value="komparz + text, " name="in3">
                                                <label class="custom-control-label " for="comparz_text">Komparz + text</label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="dabing" value="dabing, " name="in4">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="actingm" value="herectvo, " name="cr3">
                                        ...
                                        <div class="col-12 about-me">
                                            ...
                                            <textarea name="bio" id="about" rows="15" maxlength="255"></textarea>
                                        </div>
                            </div>
