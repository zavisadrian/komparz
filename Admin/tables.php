...
?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Topbar -->
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top cs-navbar-expand" style="height: 1.375rem; background-color: #f8f9fc;">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Zoznám profilov</h1>
          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary cs-header-headline-withinput">Fotografi</h6>
                        ...
                        echo " 
                            <tr class='cs-table-row'>
                                ...
                                <td style='padding: 5px;'>
                                    ...
                                    <span class=\"text\" style='color: white;'>Open</span>
                                    </a>
                                </td>
                            </tr>
                        ";
