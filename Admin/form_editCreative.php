        ...
        <div class="container-fluid">
            ...
            <form class="card shadow mb-4" action="PHP/addProfile.php" method="post" enctype="multipart/form-data" style="transform: scale(1); transform-origin: top; transition: all 0.35s cubic-bezier(0.25, 0.1, 0.28, 1.29);" onsubmit="checkData(this)">
                <div class="card-header py-3">
                    ...
                    <input name="type" type="hidden" value="creative">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input name="password" type="password" class="form-control form-control-user" id="exampleInputEmail" placeholder="" pattern=".{8,}" title="Heslo nemôžeš meniť v tomto prostredí" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            ...
                            <input name="phone" type="text" class="form-control form-control-user" id="exampleInputEmail" placeholder="+421 999 000 999" pattern=".{9, 14}" value="<?php echo $phone; ?>">
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            <h6 class="m-0 font-weight-bold text-primary cs-input-label">Pracovisko - ulica</h6>
                            <input name="street" type="text" class="form-control form-control-user" placeholder="Kremská 21" pattern=".{4,}" value="<?php echo $street; ?>">
                        </div>

                        <div class="col-sm-6">
                            <h6 class="m-0 font-weight-bold text-primary cs-input-label">Pracovisko - mesto</h6>
                            <input name="city" type="text" class="form-control form-control-user" placeholder="Stupava" pattern=".{4,}" value="<?php echo $city; ?>">
                        </div>
                    </div>

                    <div class="form-group row">
                        <div class="col-sm-6">
                            <h6 class="m-0 font-weight-bold text-primary cs-input-label">Pracovisko - PSČ</h6>
                            <input name="postcode" type="text" class="form-control form-control-user" placeholder="90221" pattern=".{4,}" value="<?php echo $postcode; ?>">
                        </div>

                        <div class="col-sm-6">
                            <h6 class="m-0 font-weight-bold text-primary cs-input-label">Pracovisko - kraj</h6>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            ...
                            <input name="web" type="text" class="form-control form-control-user" placeholder="www.example.com" value="<?php echo $work; ?>">
                        </div>

                        <div class="col-sm-6">
                            <h6 class="m-0 font-weight-bold text-primary cs-input-label">Kategória</h6>
                            <select name="category" type="text" class="form-control form-control-user">
