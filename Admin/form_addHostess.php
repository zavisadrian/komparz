                ...
                <div class="container py-7 pt-2 text-center">
                    <div class="row no-gutters">
                        ...
                        <div class="col-lg-6 col-md-6" id="form">
                            <h1>Registrácia<br>Hostesky & Promotéri</h1>
                        </div>
                            ...
                            <div class="">
                                ...
                                <div class="row pt-4">
                                    <div class="col-6">
                                        ...
                                        <input type="hidden" class="registration-input" name="type" value="hostess"/>
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="registration-input" name="mail" id="email" data-necessary="text"/>
                                    </div>
                                    <div class="col-6">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="hostessing" value="hostessing, " name="in1">
                                <label class="custom-control-label " for="hostessing">Hostessing</label>
                            </div>
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="promo" value="promo, " name="in2">
