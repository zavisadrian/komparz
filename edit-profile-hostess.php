            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="hostessing" value="hostessing, " name="in1" <?php if (strpos($interests, 'hostessing') !== false) echo "checked"; ?>>
                        <label class="custom-control-label " for="hostessing">Hostessing</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="promo" value="promo, " name="in2" <?php if (strpos($interests, 'promo') !== false) echo "checked"; ?>>
